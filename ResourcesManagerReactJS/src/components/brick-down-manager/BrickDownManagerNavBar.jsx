    ...
    <div className="rm-nav-bar flex-center fixed">
      <div className="container flex-center justify-space-between">
        <div className="flex-center">
          ...
          <li className="link-container">
            <Link className="link" to="/dashboard/allocations">
              Allocations
            </Link>
          </li>
          <li className="link-container">
            <Link className="link" to="/dashboard/repports">
              Repports
            </Link>
          </li>
          <li className="link-container">
        ...
        <div className="flex-center">
          ...
          <li className="link-container">
            <div
              className="link link-icon flex-center"
...
export default BrickDownManagerNavbar;
